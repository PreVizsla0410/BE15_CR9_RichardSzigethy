...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2022 at 04:18 PM
...
INSERT INTO `orders` (`order_ID`, `sum`, `order_address`, `customer_order`, `fk_customer_ID`) VALUES
(1, 77, 'Trautonstraße 13', 'John Travolta', '1'),
(2, 83, 'Josefstraße 13', 'Edmont Dante', '2'),
(3, 66, 'Austraße 13', 'Sequire Wiver', '3');
...
INSERT INTO `sellers` (`seller_ID`, `Seller_name`, `ContactPerson`, `category_of_sell`, `products`) VALUES
(1, 'Kevin Durants Basketballshop', 'Kevind Durant', 'bottels', 'bottle of milk'),
(2, 'Lionel Messis Soccarballshop', 'Cristiano Ronaldo', 'electric supplies', 'condensatores'),
(3, 'Jack Daniels beverages', 'Jack Daniels', 'beverages', 'whisky');
...
-- shows items where the price is under 50
